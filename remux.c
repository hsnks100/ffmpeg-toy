...
const char* url = "rtsp://192.168.103.3/ffmpeg/0:9899";
static int create_output(const char* fileName)
{
	...
	if(avformat_alloc_output_context2(&outputFile.fmt_ctx, NULL, "rtsp", url) < 0)
	{
...
int main(int argc, char* argv[])
{
	...
	av_dump_format(outputFile.fmt_ctx, 0, url, 1);
